defmodule CsChallengeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CsChallengeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CsChallengeWeb.Gettext, "errors", msg, opts)
    end
  end
